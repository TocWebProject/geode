    ...
    <div>   
        <div class="pb-32 px-7 h-full">
            ...
            <form id="geodeFormDistanciel" role="form" v-on:submit.prevent="onSubmit"> 
                ...
                <button v-if="!showResultDistanciel" type="submit" class="w-60 mx-auto mt-16 flex items-center justify-center px-5 py-4 border border-transparent text-base font-medium rounded-md text-white bg-pink-800 hover:bg-opacity-80 md:py-4 md:text-lg">
                    Evaluez l'ouverture
                </button>
