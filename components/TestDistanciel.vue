    ...
    <div>   
        <div class="pb-32 px-7 h-full">
            ...
            <form id="geodeFormDistanciel" role="form" v-on:submit.prevent="onSubmit"> 
                    ...
                    <div class="bg-white space-y-5">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-2">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geode" name="acces" id="acces" v-model.number="geodeDataDistanciel.acces" class="block w-full mt-0 rounded-md border-gray-300 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 pr-8 mb-3">
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-2">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geode" name="lieu" id="lieu" v-model.number="geodeDataDistanciel.lieu" class="block w-full mt-0 rounded-md border-gray-300 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 pr-8 mb-3">
                                            <option value="">Votre Choix</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-2">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geode" name="temps" id="temps" v-model.number="geodeDataDistanciel.temps" class="block w-full mt-0 rounded-md border-gray-300 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 pr-8 mb-3">
                                            <option value="">Votre Choix</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-2">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geode" name="rythme" id="rythme" v-model.number="geodeDataDistanciel.rythme" class="block w-full mt-0 rounded-md border-gray-300 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 pr-8 mb-3">
                                            <option value="">Votre Choix</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-2">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geode" name="objectifs" id="objectifs" v-model.number="geodeDataDistanciel.objectifs" class="block w-full mt-0 rounded-md border-gray-300 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 pr-8 mb-3">
                                            <option value="">Votre Choix</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-2">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geode" name="cheminement" id="cheminement" v-model.number="geodeDataDistanciel.cheminement" class="block w-full mt-0 rounded-md border-gray-300 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 pr-8 mb-3">
                                            <option value="">Votre Choix</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-2">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geode" name="sequence" id="sequence" v-model.number="geodeDataDistanciel.sequence" class="block w-full mt-0 rounded-md border-gray-300 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 pr-8 mb-3">
                                            <option value="">Votre Choix</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-2">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geode" name="methodes" id="methodes" v-model.number="geodeDataDistanciel.methodes" class="block w-full mt-0 rounded-md border-gray-300 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 pr-8 mb-3">
                                            <option value="">Votre Choix</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-2">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geode" name="format" id="format" v-model.number="geodeDataDistanciel.format" class="block w-full mt-0 rounded-md border-gray-300 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 pr-8 mb-3">
                                            <option value="">Votre Choix</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-2">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geode" name="contenus" id="contenus" v-model.number="geodeDataDistanciel.contenus" class="block w-full mt-0 rounded-md border-gray-300 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 pr-8 mb-3">
                                            <option value="">Votre Choix</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-2">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geode" name="evaluation" id="evaluation" v-model.number="geodeDataDistanciel.evaluation" class="block w-full mt-0 rounded-md border-gray-300 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 pr-8 mb-3">
                                            <option value="">Votre Choix</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-2">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geode" name="supports" id="supports" v-model.number="geodeDataDistanciel.supports" class="block w-full mt-0 rounded-md border-gray-300 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 pr-8 mb-3">
                                            <option value="">Votre Choix</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-2">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geode" name="communication" id="communication" v-model.number="geodeDataDistanciel.communication" class="block w-full mt-0 rounded-md border-gray-300 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 pr-8 mb-3">
                                            <option value="">Votre Choix</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-2">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geode" name="ressources" id="ressources" v-model.number="geodeDataDistanciel.ressources" class="block w-full mt-0 rounded-md border-gray-300 shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50 pr-8 mb-3">
                                            <option value="">Votre Choix</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                ...
                <button v-if="!showResultDistanciel" type="submit" class="w-60 mx-auto mt-16 flex items-center justify-center px-5 py-4 border border-transparent text-base font-medium rounded-md text-white bg-pink-700 hover:bg-pink-800 md:py-4 md:text-lg">
                    Evaluez l'ouverture
                </button>
                <a v-if="showResultDistanciel" @click="restartTest" href="#geode" class="kf-appear-2 w-60 mx-auto mt-16 flex items-center justify-center px-5 py-4 border border-transparent text-base font-medium rounded-md text-pink-800 bg-pink-100 hover:bg-pink-200 md:py-4 md:text-lg">
                    Refaire le test
                </a>
            </form>
        </div>
