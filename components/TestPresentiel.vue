    ...
    <div>   
        <div class="pb-32 px-7 bg-gray-100 bg-opacity-50 h-full">
            ...
            <form id="geodeFormPresentiel" role="form" v-on:submit.prevent="onSubmit"> 
                    ...
                    <div class="bg-gray-50 px-2 py-3 sm:px-3 sm:py-4 border-t-2 bg-opacity-5 border-blue-400 rounded-t relative">
                        <div class="max-w-md md:w-full md:mx-0">
                            <div class="inline-flex items-start space-x-1 sm:space-x-2 mb-3 sm:mb-2">
                                ...
                                />
                                <h3 class="text-2xl sm:text-3xl text-blue-700 mt-5">Géode en <span class="text-blue-600">présentiel</span></h3>
                            </div>
                ...
                <button v-if="!showResultPresentiel" type="submit" class="w-60 mx-auto mt-16 flex items-center justify-center px-5 py-4 border border-transparent text-base font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 md:py-4 md:text-lg">
                    Evaluez l'ouverture
                </button>
                <a v-if="showResultPresentiel" @click="restartTest" href="#geode" class="kf-appear-2 w-60 mx-auto mt-16 flex items-center justify-center px-5 py-4 border border-transparent text-base font-medium rounded-md text-blue-800 bg-blue-100 hover:bg-blue-200 md:py-4 md:text-lg">
                    Refaire le test
                </a>
            </form>
        </div>
