                    ...
                    <div class="bg-white space-y-5">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-1">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geodeFormPresentiel" name="acces" id="acces" v-model.number="geodeDataPresentiel.acces" class="block w-full mt-0 rounded-md border-yellow-300 shadow-sm focus:border-yellow-300 focus:ring focus:ring-yellow-200 focus:ring-opacity-50 pr-8 mb-1">
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-1">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geodeFormPresentiel" name="lieu" id="lieu" v-model.number="geodeDataPresentiel.lieu" class="block w-full mt-0 rounded-md border-yellow-300 shadow-sm focus:border-yellow-300 focus:ring focus:ring-yellow-200 focus:ring-opacity-50 pr-8 mb-1">
                                            <option value="">Votre réponse</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-1">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geodeFormPresentiel" name="rythme" id="rythme" v-model.number="geodeDataPresentiel.rythme" class="block w-full mt-0 rounded-md border-yellow-300 shadow-sm focus:border-yellow-300 focus:ring focus:ring-yellow-200 focus:ring-opacity-50 pr-8 mb-1">
                                            <option value="">Votre réponse</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-1">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geodeFormPresentiel" name="objectifs" id="objectifs" v-model.number="geodeDataPresentiel.objectifs" class="block w-full mt-0 rounded-md border-indigo-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 pr-8 mb-1">
                                            <option value="">Votre réponse</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-1">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geodeFormPresentiel" name="cheminement" id="cheminement" v-model.number="geodeDataPresentiel.cheminement" class="block w-full mt-0 rounded-md border-indigo-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 pr-8 mb-1">
                                            <option value="">Votre réponse</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-1">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geodeFormPresentiel" name="sequence" id="sequence" v-model.number="geodeDataPresentiel.sequence" class="block w-full mt-0 rounded-md border-indigo-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 pr-8 mb-1">
                                            <option value="">Votre réponse</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-1">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geodeFormPresentiel" name="methodes" id="methodes" v-model.number="geodeDataPresentiel.methodes" class="block w-full mt-0 rounded-md border-indigo-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 pr-8 mb-1">
                                            <option value="">Votre réponse</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-1">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geodeFormPresentiel" name="format" id="format" v-model.number="geodeDataPresentiel.format" class="block w-full mt-0 rounded-md border-indigo-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 pr-8 mb-1">
                                            <option value="">Votre réponse</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-1">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geodeFormPresentiel" name="contenus" id="contenus" v-model.number="geodeDataPresentiel.contenus" class="block w-full mt-0 rounded-md border-indigo-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 pr-8 mb-1">
                                            <option value="">Votre réponse</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-1">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geodeFormPresentiel" name="evaluation" id="evaluation" v-model.number="geodeDataPresentiel.evaluation" class="block w-full mt-0 rounded-md border-indigo-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 pr-8 mb-1">
                                            <option value="">Votre réponse</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-1">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geodeFormPresentiel" name="supports" id="supports" v-model.number="geodeDataPresentiel.supports" class="block w-full mt-0 rounded-md border-green-600 shadow-sm focus:border-green-500 focus:ring focus:ring-green-100 focus:ring-opacity-50 pr-8 mb-1">
                                            <option value="">Votre réponse</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-1">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geodeFormPresentiel" name="communication" id="communication" v-model.number="geodeDataPresentiel.communication" class="block w-full mt-0 rounded-md border-green-600 shadow-sm focus:border-green-500 focus:ring focus:ring-green-100 focus:ring-opacity-50 pr-8 mb-1">
                                            <option value="">Votre réponse</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
                        ...
                        <div class="md:inline-flex space-y-4 md:space-y-0 w-full p-4 sm:p-2 text-gray-600 items-center">
                            ...
                            <div class="md:w-5/12 max-w-sm mx-4 sm:mx-6">
                                ...
                                <div class="w-full inline-flex mt-1">
                                    <div class="flex-shrink w-48 inline-block relative">
                                        <select form="geodeFormPresentiel" name="ressources" id="ressources" v-model.number="geodeDataPresentiel.ressources" class="block w-full mt-0 rounded-md border-green-600 shadow-sm focus:border-green-500 focus:ring focus:ring-green-100 focus:ring-opacity-50 pr-8 mb-1">
                                            <option value="">Votre réponse</option>
                                            <option value="0">Pas du tout libre</option>
                                            <option value="1">Pas vraiment libre</option>
                                            <option value="2">Moyennement libre</option>
