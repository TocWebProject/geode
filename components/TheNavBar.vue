      ...
      <aside class="p-5 transform top-0 left-0 w-80 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30" :class="menuIsOpen ? 'translate-x-0' : '-translate-x-full'"> 
        ...
        <div class="follow pt-6">
          ...
          <div class="social flex space-x-10 mt-2">
            <a href="https://twitter.com/univ_lille" target="_blank" rel="noopener noreferrer">
              <svg 
            ...
            <a href="https://www.facebook.com/UniversitedeLille/" target="_blank" rel="noopener noreferrer">
              <svg 
            ...
            <a href="https://www.instagram.com/univ_lille/" target="_blank" rel="noopener noreferrer">
              <svg 
            ...
            <a href="https://www.youtube.com/channel/UCwQRR1SjMMfwdt0NgvFCTAg" target="_blank" rel="noopener noreferrer">
              <svg 
