<template>
    <section>
        <div class="relative bg-white overflow-hidden pb-10">
            ...
            <h2 class="kf-moveInDown text-2xl text-center tracking-tight font-extrabold text-pink-900 pt-5 sm:pt-8 md:text-3xl">Éditeur</h2>
            ...
            <p class="w-11/12 sm:w-2/3 mx-auto text-center pt-3">
                ...
                Adresse électronique : contact@univ-lille.fr<br>
                Tél. :  +33 (0)3 20 96 43 43<br>
                Fax : +33 (0)3 20 88 24 32
            </p>
            <h2 class="kf-moveInDown text-2xl text-center tracking-tight font-extrabold text-pink-900 pt-5 sm:pt-8 md:text-3xl">Directeur de la Publication</h2>
            <hr class="hr-mentions w-72 mx-auto">
            <p class="w-11/12 sm:w-2/3 mx-auto text-center pt-3">
                Monsieur Jean-Christophe Camart, Président de l'Université de Lille
            </p>
            <h2 class="kf-moveInDown text-2xl text-center tracking-tight font-extrabold text-pink-900 pt-5 sm:pt-8 md:text-3xl">Hébergement du site</h2>
            ...
            <h2 class="kf-moveInDown text-2xl text-center tracking-tight font-extrabold text-pink-900 pt-5 sm:pt-8 md:text-3xl">Technologies utilisées</h2>
            <hr class="hr-mentions w-60 mx-auto">
            <p class="w-11/12 sm:w-2/3 mx-auto text-center pt-3">
                Nuxt.js 
            </p>
            <h2 class="kf-moveInDown text-2xl text-center tracking-tight font-extrabold text-pink-900 pt-5 sm:pt-8 md:text-3xl">Ligne éditoriale</h2>
            <hr class="hr-mentions w-44 mx-auto">
            <p class="w-11/12 sm:w-2/3 mx-auto text-center pt-3">
            ...
            <h2 class="kf-moveInDown text-2xl text-center tracking-tight font-extrabold text-pink-900 pt-5 sm:pt-8 md:text-3xl">Avertissement concernant les informations disponibles sur ce site</h2>
            <hr class="hr-mentions w-72 sm:w-96 mx-auto">
            ...
            <h2 class="kf-moveInDown text-2xl text-center tracking-tight font-extrabold text-pink-900 pt-5 sm:pt-8 md:text-3xl">Liens hypertextes</h2>
            <hr class="hr-mentions w-44 mx-auto">
            <p class="w-11/12 sm:w-2/3 mx-auto text-justify pt-3">
            ...
            <h2 class="kf-moveInDown text-2xl text-center tracking-tight font-extrabold text-pink-900 pt-5 sm:pt-8 md:text-3xl">Cookies / Témoins</h2>
            <hr class="hr-mentions w-44 mx-auto">
            <p class="w-11/12 sm:w-2/3 mx-auto text-justify pt-3">
