<template>
    ...
    <div class="bg-white h-full overflow-hidden pb-10">
        ...
        <div class="min-w-11/12 mt-1 mb-10 mx-auto flex flex-wrap justify-center">
            ...
            <!-- Text Documentation -->
            <article class="kf-appear-1 flex flex-col w-3/4 lg:w-2/3 items-center px-4 mt-5 lg:mt-10 md:ml-5 lg:ml-10 xl:ml-14 sm:ml-0 overflow-auto max-h-screen">
                <h3 class="w-100 text-xl text-center font-bold mt-6 md:mr-5 sm:mr-2">
