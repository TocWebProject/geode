<template>
<div class="relative bg-white h-full overflow-hidden pb-10">
    <h3 class="text-4xl text-center tracking-tight font-extrabold text-gray-900 pt-16 sm:text-3xl md:text-4xl">Documentation</h3>
    <div class="container mt-5 mb-10 mx-auto flex flex-wrap justify-center">
        <div class="col-auto">
            <div class="w-60 lg:w-60 h-60 ml-0 mt-5 mb-7 lg:mt-10 pr-10 rounded bg-blue-100">
                <nav class="w-60 p-8 h-60">
                    <ul>
                        <p class="text-2xl">Sommaire</p>
                        <li><a href="#target1">YOOO</a></li>
                        <li><a href="#target2">YOOO</a></li>
                        <li><a href="#target3">YOOO</a></li>
        ...
        <article class="flex flex-col w-2/3 items-center px-4 mt-4 lg:ml-10 overflow-auto max-h-screen">
