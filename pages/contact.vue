            ...
            <div class="kf-appear-2 container-contact">
                <div class="lg:py-4 lg:pb-32 lg:flex lg:justify-center">
                    <div class="lg:mx-8 lg:flex lg:max-w-5xl lg:shadow-lg lg:rounded-lg">
                        <div class="bg-white lg:w-1/2 lg:p-5 ">
                            <picture>
                                ...
                                <img class="kf-moveInLeft h-48 w-full sm:h-60 md:h-64 lg:h-full lg:rounded-lg" src="~/assets/img/undraw_Work_time_re_hdyv.svg" width="472" height="320" alt="illustration de deux personnes travaillant à une table commune">
                            </picture> 
                        </div>
                        <div class="bg-pink-50 flex flex-col justify-center items-center xl:items-left h-full bg-opacity-50 hover:bg-opacity-70 py-12 px-3 md:px-10 max-w-5xl lg:w-1/2">
                            ...
                            <div class="social flex w-64 justify-between mt-2 mb-1 max-w-xs">
