  ...
  <div>
    ...
    <div class="relative bg-white h-full overflow-hidden">
      <div class="max-w-7xl mx-auto xl:mx-20">
        <div class="relative pb-8 bg-transparent sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          <!-- Header Text -->
          <section class="kf-moveInLeft mt-10 mr-auto max-w-8xl px-8 sm:mt-12 sm:px-6 md:mt-16 lg:mt-24 lg:px-10 xl:mt-28 xl:pl-20">
